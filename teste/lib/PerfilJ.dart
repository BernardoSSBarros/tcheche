...
class PerfilJPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('João Miguel', style: TextStyle(fontSize: 16)),
                const SizedBox(height: 10),
                Text('Serviço', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                Text('Construção de Muro', style: TextStyle(fontSize: 16)),
                const SizedBox(height: 10),
                Text('Data: 11/06/2025', style: TextStyle(fontSize: 14)),
                Text('Hora: 14:30', style: TextStyle(fontSize: 14)),
                Text('Rua das Acácias, 89', style: TextStyle(fontSize: 14)),
                const SizedBox(height: 16),
                Text('Pagamento', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                Text('Boleto', style: TextStyle(fontSize: 14)),
                Text("R\$200,00", style: TextStyle(fontSize: 14)),
